...
class OpticalFlowMagnitudeSum ( preprocessor ):
    ...
    def __init__(self, exportPath, trainingPath , testPath , images_size=[640,640], importPath = None , skip_count =5):
        ...
        self.name = "Optical_Flow_Mag_" + str(skip_count)
        self.x_test = None
        self.y_train = None
        self.x_train = None
    ...
    def preprocess(self):
        ...
        if( not  self.trainingPath is None):
            for sample in sorted(os.listdir(self.trainingPath)) :
                ...
                for i in range( len(t)):
                    ...
                    train_mag_sums.append(the_of_mag)
        ...
        train_mag_sums = np.vstack(train_mag_sums)
        ...
        return train_x , train_y , test_dic, test_size_ref, train_vars, test_vars, train_of , tesr_ofs, train_mag_sums , test_of_mag
